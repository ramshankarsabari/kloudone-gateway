...
export class SpeakerUpdatePage {
  ...
  async sessionSelectLastOption(): Promise<void> {
    await this.sessionSelect.all(by.tagName('option')).last().click();
  }

  async sessionSelectOption(option: string): Promise<void> {
  ...
  async getSessionSelectedOption(): Promise<string> {
